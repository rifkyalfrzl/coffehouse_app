          ...
          child: Row(
            ...
            Expanded(
              child: Column(
                ...
                children: const <Widget>[Icon(Icons.home, color: Colors.black45,)],
              )),
            Expanded(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const <Widget>[Icon(Icons.favorite, color: Colors.black45,)],
              )),
            Expanded(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const <Widget>[Icon(Icons.category, color: Colors.black45,)],
              )),
            Expanded(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const <Widget>[Icon(Icons.person, color: Colors.black45,)],
              )),
            ],
          ),
      ),
