...
import 'package:coffee_app/coffee_desc.dart';
                    ...
                    Row(
                      ...
                      InkWell(
                        child: Container(
                          ...
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => CoffeeDesc(coffeeImagePath: coffeeImagePath, coffeeName: coffeeName)),);
                          },
                      ),
                    ],)
                  ],
